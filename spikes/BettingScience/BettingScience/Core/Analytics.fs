...
let private getMatchResult ({ Home = home; Away = away }:MatchScore) = if home > away then Home else if home = away then Draw else Away
let private getAccuracy out odds result { Expected = e; Variance = v } =
